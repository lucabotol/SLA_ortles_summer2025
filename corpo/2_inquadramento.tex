...
\begin{figure}[H]
    ...
    \caption{Rappresentazione mediante DTM e hillshade della Val de la Mare (TN), mediante la delimitazione di colore nero.}
    \label{fig:dtm_valdisole}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{immagini/area_interesse.pdf}
    \caption{Zona d'interesse considerata ai fini dello studio: l'alta Val de la Mare (TN). È possibile notare (nell’area più orientale della delimitazione) il Lago del Careser.}
    \label{fig:area_interesse}
\end{figure}

Utilizzando i dati meteorologici, ricavati dalla stazione posta su Lago del Careser e successivamente corretti mediante post-processing, è possibile conoscere la climatologia della Val di Peio, per gli anni idrologici dal 1940 al 2024 \cite{Carturan_DallaFontana_Borga_2012} (\cref{fig:clima_valpeio}).
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{immagini/pluviometria_temperatura_anno_idrologico.pdf}
    \caption{Precipitazione cumulata e temperatura media della Val di Peio, dal 1940 al 2024 (anno idrologico)\cite{Carturan_DallaFontana_Borga_2012}.}
...
Pur non indicando la situazione climatica per l'anno d'interesse per questa relazione (2025), il grafico permette comunque di capire quale sia stata la tendenza del recente passato.