\section{Risultati}
L'applicazione dell'indice a ogni immagine Sentinel-2 e il calcolo della percentuale di celle innevate consentono di stimare la quota neve (definita come la fascia innevata più bassa) per ogni data di acquisizione.
...
\begin{figure}[H]
     ...
     \caption{Isopse (a 20 metri) indicanti le condizioni di innevamento al suolo della Val de la Mare. Le fasce rosse rappresentano le aree considerate innevate, mentre quelle verdi rappresentano una condizione di non innevamento.}
