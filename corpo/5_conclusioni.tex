...
\end{table}
È possibile notare come ci sia un ridotto scarto tra i valori osservati e quelli ricavati dai prodotti Sentinel-2. I risultati ottenuti dimostrano l'efficacia e la relativa accuratezza dell'indice NDSI, validandone l'impiego per il monitoraggio preliminare e multitemporale del manto nevoso.\\
Dalle analisi effettuate è emersa una criticità del modello NDSI nel distinguere correttamente il ghiaccio scoperto dalla neve (soprattutto se esposto verso sud); in tali condizioni, l'indice non sempre riesce a garantire una discriminazione ottimale delle superfici.\\
Infatti, è stato notato che l'indice tende a sovrastimare l'area innevata, poiché include anche le aree ghiacciate. Per tale motivo, prima di effettuare uno studio sulla copertura nevosa, sarebbe da effettuare una  delimitazione areale del terreno coperto da ghiacciaio.\\
